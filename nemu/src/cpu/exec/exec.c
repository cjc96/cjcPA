...
/* 0x80 */
make_group(group1_b,
	add_i2rm_b, xor_i2rm_b, adc_i2rm_b, sbb_i2rm_b, 
	and_i2rm_b, sub_i2rm_b, xor_i2rm_b, cmp_i2rm_b)

/* 0x81 */
make_group(group1_v,
	add_i2rm_v, xor_i2rm_v, adc_i2rm_v, sbb_i2rm_v, 
	and_i2rm_v, sub_i2rm_v, xor_i2rm_v, cmp_i2rm_v)

/* 0x83 */
make_group(group1_sx_v,
	add_si2rm_v, xor_i2rm_v, adc_si2rm_v, sbb_si2rm_v, 
...
/* 0xb4 */	inv, inv, movzbl_rm2r_v, movzbl_rm2r_v, 
