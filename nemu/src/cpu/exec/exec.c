...
/* 0x80 */
make_group(group1_b,
	add_i2rm_b, adc_i2rm_b, adc_i2rm_b, sbb_i2rm_b, 
	and_i2rm_b, sub_i2rm_b, xor_i2rm_b, cmp_i2rm_b)

/* 0x81 */
make_group(group1_v,
	add_i2rm_v, adc_i2rm_v, adc_i2rm_v, sbb_i2rm_v, 
...
make_group(group5,
	...
	jmpnear_rm_v, inv, push_rm_v, inv)
...
/* 0x8c */	inv, lea, movseg_r2rm_v, pop_rm_v,
...
/* 0xe8 */	call_i_v, jmp_i_v, jmpsp, jmp_i_b,
/* 0xec */	inb, ind, outb, outd,
/* 0xf0 */	inv, inv, rep, rep,
/* 0xf4 */	hlt, inv, group3_b, group3_v,
/* 0xf8 */	clc, inv, cli, sti,
...
/* 0x20 */	movcr_rm2r_v, inv, movcr_r2rm_v, inv, 
