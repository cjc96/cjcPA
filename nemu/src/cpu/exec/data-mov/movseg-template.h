...
static void do_execute () {
	...
	uint32_t temp_describe0 = swaddr_read(temp_addr, 1), temp_describe1 = swaddr_read(temp_addr + 1, 1), temp_describe2 = swaddr_read(temp_addr + 2, 1), temp_describe3 = swaddr_read(temp_addr + 3, 1), temp_describe4 = swaddr_read(temp_addr + 4, 1), temp_describe5 = swaddr_read(temp_addr + 5, 1), temp_describe6 = swaddr_read(temp_addr + 6, 1), temp_describe7 = swaddr_read(temp_addr + 7, 1);
